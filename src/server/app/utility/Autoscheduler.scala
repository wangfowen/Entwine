...
//	
//	case class OwnedTimeBlock(owner: User, time: TimeBlock)
//	case class CommonTimeBlock(startTime: Long, endTime: Long, participants: List[Participation])
//	
//	private implicit def ctbToTb(value: CommonTimeBlock): TimeBlock = {
//		new TimeBlock(-1, -1, value.startTime, value.endTime)
//	}
//	
//	private implicit def tbToCtb(value: (CommonTimeBlock, TimeBlock)): CommonTimeBlock = {
//	  new CommonTimeBlock(value._2.startTime, value._2.endTime, value._1.participants)
//	}
//	
